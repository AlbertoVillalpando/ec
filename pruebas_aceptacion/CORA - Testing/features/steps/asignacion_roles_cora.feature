...
Y al usuario con nombre "Joel" de apellido "Salas" activo el rol "REVISOR"
Cuando presiono el botón Guardar Cambios
Entonces el sistema valida la selección y muestra en la columna ROL el texto "Revisor" del usuario "Joel" "Salas"
