...
Y ingreso mi nombre "jose emmanuel", apellido "sandoval sanchez", correo "usuario6@example.com" y una contraseña "ContrasenaSegura123"
...
Y selecciono el área de conocimiento "Medicina"
Cuando presiono el botón "Registrarse"
Entonces debo ver un mensaje de error "Ya existe Usuario con este Email."
